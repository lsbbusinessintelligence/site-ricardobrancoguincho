  ...
  <section id="home" className="hero-gradient relative overflow-hidden min-h-[90vh] flex items-center scroll-mt-28">
    ...
    <div className="container relative z-10 py-20 md:py-32">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="bg-[#1A0002] rounded-3xl shadow-2xl p-6 max-w-md border border-[#3D0004]">
            <div className="relative overflow-hidden rounded-2xl bg-[#1A0002]">
              <img
            ...
            <div className="relative overflow-hidden rounded-2xl bg-[#1A0002] mt-4">
              <img
